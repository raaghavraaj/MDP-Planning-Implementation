...
def DrawGrid():
    ...
    print("     |     |     ")
    print(
        f"  {cell_value(grid[0][0])}  |  {cell_value(grid[0][1])}  |  {cell_value(grid[0][2])}  ")
    print("_____|_____|_____")
    print("     |     |     ")
    print(
        f"  {cell_value(grid[1][0])}  |  {cell_value(grid[1][1])}  |  {cell_value(grid[1][2])}  ")
    print("_____|_____|_____")
    print("     |     |     ")
    print(
        f"  {cell_value(grid[2][0])}  |  {cell_value(grid[2][1])}  |  {cell_value(grid[2][2])}  ")
    print("     |     |     ")
    print()
